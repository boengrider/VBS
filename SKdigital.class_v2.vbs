Class SKDIG
	...
	Public Property Get SubjectValidInPublicReg
		...
		If IsNull(aRetVals(9)) Then  ' For now we assume anything else than Null means N/A. We simply only accept Null as an indicator of an active subject
			SubjectValidInPublicReg = 1 ' False
			Exit Property 
		ElseIf IsDate(aRetVals(9)) Then ' There is a termination date. This subject is inactive
			SubjectValidInPublicReg = 0 ' False
			Exit Property
		Else
			SubjectValidInPublicReg = 2 ' N/A
			Exit Property
		End If 
