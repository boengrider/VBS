...
debug.WriteLine vat.CheckVatA("SK","2022045124")
...
Class EUVATChecker
	...
	Private Sub Class_Initialize()
		...
		oXML.setProperty "SelectionNamespaces", "xmlns:ns2=""urn:ec.europa.eu:taxud:vies:services:checkVat:types"""
	...
	Public Function CheckVatA(strCtryCode, strVatNum)
		...
		For Each oXmlNode In oXML.getElementsByTagName("ns2:valid")
